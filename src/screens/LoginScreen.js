      ...
      >
        ...
        >
          ...
          <View style={styles.authPanel}>
            ...
            <Pressable onPressIn={onPressIn} onPressOut={onPressOut} onPress={handleLogin} disabled={isBusy}>
              <Animated.View
                style={[
                  styles.authMainBtn,
              ...
              >
                <Text style={styles.authMainBtnText}>{isBusy ? 'Please wait...' : 'Login'}</Text>
              </Animated.View>
            </Pressable>

            <View style={styles.authSwitchRow}>
              <Text style={styles.authSwitchLabel}>Don't have account? </Text>
              <TouchableOpacity onPress={() => navigation.navigate('Register')} activeOpacity={0.7} disabled={isBusy}>
